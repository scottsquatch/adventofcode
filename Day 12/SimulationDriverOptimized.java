...
public class SimulationDriverOptimized
{
	private Rules rules;
	private PotCollectionOptimized pots;

	public SimulationDriverOptimized(String initialState, Rules rules)
	{
		this.rules = rules;
		this.pots = new PotCollectionOptimized(initialState);
