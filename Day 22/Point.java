...
public class Point implements Comparable<Point>
{
	...
	private static final Pattern REGEX_POINT = Pattern.compile("([0-9]+),\\s*([0-9]+)");
	public int x;
	public int y;
	...
	{
		Matcher matcher = REGEX_POINT.matcher(s);

		if (!matcher.matches())
		{
			throw new IllegalArgumentException(s + " is not of correct form: x,y");
		}
